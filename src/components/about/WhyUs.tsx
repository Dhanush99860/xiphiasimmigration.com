...
export default function WhyUs() {
  ...
  return (
    <section aria-labelledby={titleId} className="py-6 md:py-6">
      ...
      <div className="container mx-auto lg:max-w-screen-2xl px-4 sm:px-6 lg:px-8 overflow-x-clip">
        ...
        >
          ...
          <header className="relative mb-6 md:mb-8">
            ...
            <h2 id={titleId} className="mt-3 text-2xl font-semibold tracking-tight md:text-3xl lg:text-[32px]">
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 text-sm leading-6 text-zinc-700 dark:text-zinc-300 break-words">{text}</p>
...
function ShieldCheck() {
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5 text-blue-600 dark:text-blue-300" fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden>
...
function CheckTiny() {
  return (
    <svg viewBox="0 0 20 20" className="mt-0.5 h-3.5 w-3.5 text-blue-600 dark:text-blue-300" fill="currentColor" aria-hidden>
